<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2staff.master" AutoEventWireup="true" CodeFile="picstaff.aspx.cs" Inherits="picstaff" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            SelectCommand="SELECT * FROM [fd6]"></asp:SqlDataSource>
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
            SelectCommand="SELECT * FROM [fd]"></asp:SqlDataSource>
    </p>
    <p>
        &nbsp;</p>
    <p>
        <asp:Chart ID="Chart1" runat="server" BorderlineWidth="0" 
           Height="425px" Width="982px" DataSourceID="SqlDataSource4" 
            onload="Chart1_Load">
            <Series>
