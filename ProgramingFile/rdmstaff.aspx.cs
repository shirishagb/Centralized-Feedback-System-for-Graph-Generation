...
public partial class rdmstaff : System.Web.UI.Page
{
    ...
    protected void Button7_Click(object sender, EventArgs e)
    {
        ...
        a5 = TextBox5.Text;
        a6 = TextBox6.Text;
        string insertq1 = "update fd6 set co=@a1 where srno=@co1";
        SqlCommand com1 = new SqlCommand(insertq1, conn1);
        string insertq2 = "update fd6 set co=@a2 where srno=@co2";
        SqlCommand com2 = new SqlCommand(insertq2, conn1);
        string insertq3 = "update fd6 set co=@a3 where srno=@co3";
        SqlCommand com3 = new SqlCommand(insertq3, conn1);
        string insertq4 = "update fd6 set co=@a4 where srno=@co4";
        SqlCommand com4 = new SqlCommand(insertq4, conn1);
        string insertq5 = "update fd6 set co=@a5 where srno=@co5";
        SqlCommand com5 = new SqlCommand(insertq5, conn1);
        string insertq6 = "update fd6 set co=@a6 where srno=@co6";
    ...
    protected void Button8_Click(object sender, EventArgs e)
    {
        ...
        string co6 = "co6";
        string b = "";
        string deletq1 = "update fd6 set SA=@b,A=@b,S=@b,D=@b where srno=@co1";
        string deletq2 = "update fd6 set SA=@b,A=@b,S=@b,D=@b where srno=@co2";
        string deletq3 = "update fd6 set SA=@b,A=@b,S=@b,D=@b where srno=@co3";
        string deletq4 = "update fd6 set SA=@b,A=@b,S=@b,D=@b where srno=@co4";
        string deletq5 = "update fd6 set SA=@b,A=@b,S=@b,D=@b where srno=@co5";
        string deletq6 = "update fd6 set SA=@b,A=@b,S=@b,D=@b where srno=@co6";
